...
//		initLayout();
		// 初始化合成对象
		mTts = SpeechSynthesizer.createSynthesizer(XunFeiActivity.this, mTtsInitListener);
...
//		mInstaller = new  ApkInstaller(XunFeiActivity.this);
		setParam();
	}
...
//		findViewById(R.id.tts_play).setOnClickListener(XunFeiActivity.this);
//		findViewById(R.id.tts_cancel).setOnClickListener(XunFeiActivity.this);
//		findViewById(R.id.tts_pause).setOnClickListener(XunFeiActivity.this);
//		findViewById(R.id.tts_resume).setOnClickListener(XunFeiActivity.this);
//		findViewById(R.id.image_tts_set).setOnClickListener(XunFeiActivity.this);
//		findViewById(R.id.tts_btn_person_select).setOnClickListener(XunFeiActivity.this);
//
...
//				Intent intent = new Intent(XunFeiActivity.this, TtsSettings.class);
...
//				showTip(error.getPlainDescription(true));
	...
	protected void onResume() {
		//移动数据统计分析
		FlowerCollector.onResume(XunFeiActivity.this);
	...
	protected void onPause() {
		...
		FlowerCollector.onPause(XunFeiActivity.this);
		super.onPause();
	}
